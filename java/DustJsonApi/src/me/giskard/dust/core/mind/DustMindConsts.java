...
public interface DustMindConsts extends DustConsts, DustUtilsConsts {
	...
	String TOKEN_MIND = DUST_UNIT_DUST + DUST_SEP_TOKEN + NAME_MIND;

	String TOKEN_TYPES = DUST_UNIT_DUST + DUST_SEP_TOKEN + "types";
	String TOKEN_ATTRIBUTES = DUST_UNIT_DUST + DUST_SEP_TOKEN + "attributes";
	...
	String TOKEN_KBMETA_TAG = DUST_UNIT_DUST + DUST_SEP_TOKEN + "Tag";

	String TOKEN_UNIT_OBJECTS = DUST_UNIT_DUST + DUST_SEP_TOKEN + "UnitObjects";
	String TOKEN_UNIT_REFS = DUST_UNIT_DUST + DUST_SEP_TOKEN + "UnitRefs";
