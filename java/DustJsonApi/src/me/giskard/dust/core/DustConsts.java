...
public interface DustConsts {
	...
	String TOKEN_CMD_LOAD = DUST_UNIT_DUST + DUST_SEP_TOKEN + "load";
	...
	String TOKEN_COLLTYPE = DUST_UNIT_DUST + DUST_SEP_TOKEN + "colltype";
	...
	String TOKEN_PREFIX = DUST_UNIT_DUST + DUST_SEP_TOKEN + "prefix";
	String TOKEN_PATH = DUST_UNIT_DUST + DUST_SEP_TOKEN + "path";
	String TOKEN_COUNT = DUST_UNIT_DUST + DUST_SEP_TOKEN + "count";
	String TOKEN_INFO = DUST_UNIT_DUST + DUST_SEP_TOKEN + "Info";

	String TOKEN_INIT = DUST_UNIT_DUST + DUST_SEP_TOKEN + "init";
	String TOKEN_AGENT = DUST_UNIT_DUST + DUST_SEP_TOKEN + "agent";
	String TOKEN_SKIP = DUST_UNIT_DUST + DUST_SEP_TOKEN + "skip";

	String TOKEN_BINARY_RESOLVER = DUST_UNIT_DUST + DUST_SEP_TOKEN + "binaryResolver";
	String TOKEN_BINARY = DUST_UNIT_DUST + DUST_SEP_TOKEN + "binary";

//	String TOKEN_PARAMS = DUST_UNIT_ID + DUST_SEP_TOKEN + "params";
	String TOKEN_LISTENERS = DUST_UNIT_DUST + DUST_SEP_TOKEN + "listeners";
	String TOKEN_ALIAS = DUST_UNIT_DUST + DUST_SEP_TOKEN + "alias";
	String TOKEN_SOURCE = DUST_UNIT_DUST + DUST_SEP_TOKEN + "source";
	String TOKEN_SERIALIZER = DUST_UNIT_DUST + DUST_SEP_TOKEN + "serializer";
	...
	String TOKEN_PASSWORD = DUST_UNIT_DUST + DUST_SEP_TOKEN + "password";
	String TOKEN_AUTH = DUST_UNIT_DUST + DUST_SEP_TOKEN + "auth";
	...
	String TOKEN_PARENT = DUST_UNIT_DUST + DUST_SEP_TOKEN + "parent";
	String TOKEN_TARGET = DUST_UNIT_DUST + DUST_SEP_TOKEN + "target";
	String TOKEN_MEMBERS = DUST_UNIT_DUST + DUST_SEP_TOKEN + "members";
	String TOKEN_CHILDMAP = DUST_UNIT_DUST + DUST_SEP_TOKEN + "childMap";
	String TOKEN_FILTER = DUST_UNIT_DUST + DUST_SEP_TOKEN + "filter";
	String TOKEN_ROOT = DUST_UNIT_DUST + DUST_SEP_TOKEN + "root";
	...
	String TOKEN_TYPE_SERVICE = DUST_UNIT_DUST + DUST_SEP_TOKEN + "Service";
	String TOKEN_TYPE_RELEASEONSHUTDOWN = DUST_UNIT_DUST + DUST_SEP_TOKEN + "releaseOnShutdown";

	String TOKEN_RESULT_REJECT = DUST_UNIT_DUST + DUST_SEP_TOKEN + "Reject";
	String TOKEN_RESULT_PASS = DUST_UNIT_DUST + DUST_SEP_TOKEN + "Pass";
	...
	String TOKEN_LEVEL_WARNING = DUST_UNIT_DUST + DUST_SEP_TOKEN + "Warning";
	String TOKEN_LEVEL_ERROR = DUST_UNIT_DUST + DUST_SEP_TOKEN + "Error";

	String TOKEN_MANDATORY = DUST_UNIT_DUST + DUST_SEP_TOKEN + "mandatory";
	String TOKEN_OPTIONAL = DUST_UNIT_DUST + DUST_SEP_TOKEN + "optional";
	String TOKEN_APPEARS = DUST_UNIT_DUST + DUST_SEP_TOKEN + "appears";

	String TOKEN_FINAL = DUST_UNIT_DUST + DUST_SEP_TOKEN + "final";
	...
	String TOKEN_TEXT_STRING = DUST_UNIT_TEXT + DUST_SEP_TOKEN + "String";
	...
	String TOKEN_TEXT_GROUP_INLINE = DUST_UNIT_TEXT + DUST_SEP_TOKEN + "groupInline";
