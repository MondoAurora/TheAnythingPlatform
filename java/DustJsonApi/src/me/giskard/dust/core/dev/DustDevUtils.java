...
//
//	@Deprecated
//	protected void loadExtFile(DustHandle unit, File extFile) throws IOException, FileNotFoundException {
//		if (extFile.isFile()) {
...
//						DustHandle aType = Dust.getHandle(unit, DustUtils.getMindMeta(TOKEN_KBMETA_TYPE), access[0], DustOptCreate.Meta);
//						DustHandle aCfg = Dust.getHandle(unit, aType, access[1], DustOptCreate.None);
//
//						if (null == aCfg) {
...
//								v = Dust.getHandle(unit, null, val.substring(2), DustOptCreate.None);
//							}
//
